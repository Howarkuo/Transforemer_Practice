#Three Attention Mechanisms: 1. Encoder Self-Attention (unmasked). 2. Decoder Causal Self-Attention (masked). 3. Encoder-Decoder Cross-Attention (Decoder queries Encoder keys/values).
